...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_RAISE] = LAYOUT(
      KC_CIRC, KC_BSLS, KC_PMNS, KC_UNDS, KC_SLSH, KC_PIPE,                          _______, _______, _______, _______, KC_LPRN, KC_RPRN, 
      KC_TILD, KC_DQUO, _______, KC_HOME, KC_UP,   KC_END,                           _______, _______, _______, _______, KC_LCBR, KC_RCBR, 
      KC_AMPR, KC_PPLS, KC_ASTR, KC_LEFT, KC_DOWN, KC_RGHT,                          _______, _______, _______, KC_COPY, KC_LBRC, KC_RBRC, 
      _______, _______, KC_COLN, _______, _______, _______, _______,        _______, _______, _______, _______, KC_SLCT, KC_LT,   KC_GT,
